    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, fontSize: 16, color: '#f0f6fc' }}>togit</div>
            <div style={{ fontSize: 12, color: '#8b949e' }}>deployer</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: '#8b949e', textTransform: 'capitalize' }}>
              {user.role}
            </div>
          </div>
        </div>
